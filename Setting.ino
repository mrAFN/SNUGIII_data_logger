...
void menuSetting() {
  ...
  while (1) {
    ...
    if (Key) {                                                                              // Jika Keypad ada tombol ditekan
      ...
      if (Key == MEN) {                                                                     // Jika tombol yang ditekan MEN
        ...
        switch (menu) {
          ...
          case 3: valueSetting(3); break;
          case 4: valueSetting(4); break;
          case 5: valueSetting(5); break;
          case 6: resetFileName(); break;
        }
      }
      Key = char(0);
    }
    ...
    switch (menu) {
      ...
      case 2: lcdPrint(0, 1, "  OPERATOR ID  "); break;
      case 3: lcdPrint(0, 1, "  KODE ITEM    "); break;
      case 4: lcdPrint(0, 1, "  KODE BATCH   "); break;
      case 5: lcdPrint(0, 1, "  TARGET QTY   "); break;
      case 6: lcdPrint(0, 1, "  RESET FILES  "); break;
    }
  }
}
//------------------------------------------------------------------------------------------
void valueSetting(int menu) {
  ...
  switch (menu) {
    ...
    case 3: val = EEPROM.readInt(EE_ITEM); break;
    case 4: val = EEPROM.readInt(EE_KODE); break;
  ...
  while (1) {
    ...
    if (Key) {                                                                              // Jika Keypad ada tombol ditekan
      ...
      if (byte(Key) >= 48 and byte(Key) <= 57) {
        ...
        switch (menu) {
          ...
          case 3: EEPROM.writeInt(EE_ITEM, val); break;
          case 4: EEPROM.writeInt(EE_KODE, val); break;
    ...
    switch (menu) {
      case 2: lcdPrint(0, 0, "  OPERATOR ID  "); break;
      case 3: lcdPrint(0, 0, "  KODE ITEM    "); break;
      case 4: lcdPrint(0, 0, "  KODE BATCH   "); break;
      case 5: lcdPrint(0, 0, "  TARGET QTY   "); break;
    }
